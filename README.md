...
Simply share a password to members who want to join, when they connect to the server for the first time they are greeted with a password screen. If they enter the password correctly they are added to the whitelist and will not be shown it again.
